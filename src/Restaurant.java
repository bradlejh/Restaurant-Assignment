...
import javax.swing.UnsupportedLookAndFeelException;
	...
	public class Restaurant extends JFrame {
		...
		public Restaurant() {
			...
			addComboBox(jp,jlNumCooks, jcbNumCooks, 5,0);
			...
			jbRestaurant.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent ae) {
					if (jbRestaurant.getText().equals("Start Restaurant")) {
						...
						cookFactory=new CookFactory(cp,getNumCooks());
...
class CookPanel extends JPanel{
	public static JTextArea cookMessages;
	public JScrollPane jsp;
	public CookPanel()
	{
		
		cookMessages = new JTextArea("", 20, 30);
		cookMessages.setLineWrap(false);
		cookMessages.setFont(new Font("Arial",Font.PLAIN, 12));
		 jsp = new JScrollPane(cookMessages);
		 this.add(jsp);
		 setSize(300,500);
		// setPreferredSize(new Dimension(500,300));
	}
	public static void addCookMessage(String msg){
		String text=CookPanel.cookMessages.getText();
		if(text==null|| text.length()==0){
			CookPanel.cookMessages.setText(msg);
		}
		else{
			CookPanel.cookMessages.setText(CookPanel.cookMessages.getText() + "\n" + msg);
		}
	}
}